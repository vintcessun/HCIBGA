...
// newToolsNode component initialization function of node 'Search' in graph 'HCIBGASuggestion'
...
// newToolsNode1 component initialization function of node 'InformationLibrary' in graph 'HCIBGASuggestion'
