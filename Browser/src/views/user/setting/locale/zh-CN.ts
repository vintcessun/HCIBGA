export default {
  ...
  // new
  'userSetting.label.certification': '学校信息',
  ...
  'userSetting.tab.certification': '学校信息',
  ...
  'userSetting.certification.title.enterprise': '学校认证',
  ...
  'userSetting.certification.label.legalPerson': '姓名',
  'userSetting.certification.label.certificateType': '证件类型',
  'userSetting.certification.label.authenticationNumber': '身份证号码',
  'userSetting.certification.label.enterpriseName': '学校名称',
  'userSetting.certification.title.record': '认证记录',
  'userSetting.certification.columns.certificationType': '认证类型',
  'userSetting.certification.cell.certificationType': '学校证件认证',
